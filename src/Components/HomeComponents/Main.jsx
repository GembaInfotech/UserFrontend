  ...
  return (
    <div className='pt-16' >
      <div className="bg-white  py-2 mx-auto  md:mt-20 sm:my-4 w-3/4 rounded-lg">
        ...
        <div className="container  flex items-center justify-between px-2">
          ...
          <Link to={`/parking/${location}`}>
            <button className="bg-blue-500 text-white px-4 max-md:px-2 py-2 rounded-lg hover:bg-blue-600 transition duration-300">
              <div className='flex'>
      ...
      <section className='mt-24' >
        <div className='h-[700px]  bg-white py-6 px-12 mt-12 mb-16 '>
