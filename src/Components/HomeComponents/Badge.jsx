function Badge() {
  ...
  return (
    <div className='flex mt-24 max-md:mt-18 justify-center'>
      <div >
        <h1 className='text-white font-bold text-4xl text-center'>Why Park Your Vehicle with us?</h1>
        <div className=" w-full pt-12 p-4">
          <div className="grid gap-14 md:grid-cols-3 md:gap-5">
            <div className="rounded-xl bg-white p-6 text-center shadow-xl">
              <div
                className="mx-auto flex h-12 w-12 -translate-y-12 transform items-center justify-center rounded-full bg-teal-400 shadow-lg shadow-teal-500/40">
              ...
              <h1 className="text-darken mb-3 text-xl font-medium lg:px-14">Quick Booking</h1>
            ...
            <div data-aos-delay="150" className="rounded-xl bg-white p-6 text-center shadow-xl">
              <div
                className="mx-auto flex h-12 w-12 -translate-y-12 transform items-center justify-center rounded-full shadow-lg bg-rose-500 shadow-rose-500/40">
              ...
              <h1 className="text-darken mb-3 text-xl font-medium lg:px-14 ">Nearby Place</h1>
              <p className="px-4 text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo iure inventore amet
                modi
                accusantium vero perspiciatis, incidunt dicta sed aspernatur!</p>
            </div>
            <div data-aos-delay="300" className="rounded-xl bg-white p-6 text-center shadow-xl">
              <div
                className="mx-auto flex h-12 w-12 -translate-y-12 transform items-center justify-center rounded-full shadow-lg bg-sky-500 shadow-sky-500/40">
              ...
              <h1 className="text-darken mb-3 pt-3 text-xl font-medium lg:h-14 lg:px-14">Safety & Security</h1>
              <p className="px-4 text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo iure inventore amet
                modi
                accusantium vero perspiciatis, incidunt dicta sed aspernatur!</p>
            </div>
