    ...
    <div className=" bg-gray-800">
      <div className="max-w-2xl mx-auto text-white py-10">
        <div className="text-center">
          <h3 className="text-3xl mb-3"> Download our Parking app </h3>
          <p> Park your car at finger prints. </p>
        ...
        <div className="mt-16 flex flex-col md:flex-row md:justify-between items-center text-sm text-gray-400">
          ...
          <div className="order-1 md:order-2">
            ...
            <Link to='/contact'><span className="px-2 border-l">Contact us</span></Link>
