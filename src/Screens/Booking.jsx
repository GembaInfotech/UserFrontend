...
function Booking() {
      ...
      try {
       ...
       await setToDate(Totime);
        const bookingDetails = {
          ...
          bookingPrice: parkingData.capacity
        };
    ...
    useEffect(() => {
      ...
      console.log("msgg" ,storedUserData._id);
  ...
  return (
    <section className='flex min-h-screen '>
         ...
         <h1 className='text-xl font-bold'><PiCurrencyInrBold />{parkingData.capacity}</h1>
         </div>
         <button
